              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form  method="post" id="myForm" class="myForm" action="addProduct.php">
    ...
    <select name="idcategory" id="idcategory" required>
        ...
        <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <input modele="text" class="form-control" id="modele" placeholder="Modele" name="modele">
                        <span id="errormodele"></span>
                      </div>
                      <div class="form-group">
                        <label for="prix">Prix</label>
                        <input  class="form-control" id="prix" placeholder="Prix" name="prix">
