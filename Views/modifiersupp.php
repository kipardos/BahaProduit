...
$listeproduitsC = $produitsC->showProduct();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <main id="main" class="main">
          ...
          <li class="breadcrumb-item active">Dashboard</li>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listes De Produits</h4>
    ...
    foreach ($listeproduitsC as $produits) {
        ...
        ?>
        <tr>
            <td><?php echo $produits['marque']; ?></td>
            <td><?php echo $produits['modele']; ?></td>
            <td><?php echo $produits['prix']; ?></td>
            <td><?php echo $categoryTitle; ?></td>
            <td><?php echo $produits['image']; ?></td>
            <td>
                <a href="modifierTemp.php?id=<?php echo $produits['id_produit']; ?>" class="btn btn-primary mr-2">Modifier</a>
            </td>
            <td>
                <a href="supprimer.php?id=<?php echo $produits['id_produit']; ?>" class="btn btn-primary mr-2">Supprimer</a>
            </td>
        </tr>
        <?php
    }
